// js/chat.js
import DOM, { state, saveState, saveAllAlbums } from "./var.js";
...
// Mensaje de bienvenida claro y con ejemplos concretos
...
// Inyectar bienvenida SOLO si el chat está vacío
...
export async function triggerChatAction() {
  ...
  const replyText = await procesarComandoIA(text || "", fileToProcess, () => {
    saveAllAlbums();
...
// Función legacy (por si se usa el input file sin texto)
