...
<body data-message="<?= htmlspecialchars($modal_message ?? '', ENT_QUOTES, 'UTF-8') ?>"
    ...
    <nav class="navbar" id="dynamicNavbar">
        <div class="container nav-container">
            ...
            <ul class="nav-links">
                ...
                <li><a href="#player">Santuario</a></li>
    ...
    <section id="hero" class="hero-cosmic">
        <div class="container hero-content">
            ...
            <div class="hero-buttons">
                ...
                <a href="#player" class="btn-secondary-link">Explorar el santuario <i data-lucide="arrow-right"></i></a>
            </div>
    ...
    <!-- ==================== REPRODUCTOR ==================== -->
    <section id="player" class="interface-santuario">
        <div class="container">
            <header class="section-header text-center">
                <span class="section-tagline">✦ Familiar y Avanzado</span>
                <h2 class="section-title">El Cuarto de Escucha</h2>
                <p class="section-description">
                    Una interfaz que respira la misma atmósfera oscura y precisa que tu reproductor favorito.
                </p>
            </header>
            <div class="mockup-clean-wrapper">
                <div class="mockup-display">
                    <div class="mockup-fallback">
                        ...
                        <p>Vista previa del santuario autónomo</p>
                    </div>
                </div>
