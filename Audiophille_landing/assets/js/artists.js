...
import { toggleFollowArtist } from "./services/artistService.js"; // 👈 NUEVO
import { showAlert } from "./modals.js"; // 👈 PARA MANEJAR ERRORES
...
export async function openArtistProfile(artistName) {
  ...
  // Renderizado (se mantiene igual, pero los estilos inline se pueden mover a CSS después)
