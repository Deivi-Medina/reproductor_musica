...
// ============================================================
// OBTENER DATOS DEL ARTISTA DESDE LA API
// ============================================================
...
export async function openArtistProfile(artistName) {
  ...
  // Renderizado del perfil del artista
  ...
  // ============================================================
  // RENDERIZAR ÁLBUMES DEL ARTISTA (TODOS, CON BOTÓN AÑADIR)
  // ============================================================
  ...
  if (grid) {
    ...
    if (artistAlbums.length === 0) {
      ...
      artistAlbums.forEach((album) => {
        ...
        // Determinar si el álbum es del usuario o del sistema
        const isUserAlbum = album.id_usuario === state.user_id || album.es_sistema == 1;
        ...
        addBtn.addEventListener("click", async (e) => {
          ...
          if (isCurrentlyAdded) {
            await removeAlbumFromLibrary(album.id_album, addBtn);
          } else {
            await addAlbumToLibrary(album.id_album, addBtn);
          }
        });

        // EVENTO: botón de "preview"
...
// ============================================================
// FUNCIONES PARA AÑADIR/ELIMINAR DE BIBLIOTECA
// ============================================================
